...
//       <div className="mb-4">Добавлено:<b>{date}</b> {/*post?.author?.node?.name*/}</div>
//       <div className="article md:text-lg text-base text-justify font-medium leading-relaxed text-[#3a3127] tracking-wide antialiased" dangerouslySetInnerHTML={{ __html: post?.content }}/>
//     </div>
//   )
// }
...
//       </div>
//       <div
//         className="article md:text-lg text-base text-justify font-medium leading-relaxed text-[#3a3127] antialiased"
