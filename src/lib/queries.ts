...
//       posts(first: 10, where: { categoryName: $categorySlug }) {
//         nodes {
//           id
//           title
//           slug
...
//   type Response = {
//     posts: {
//       nodes: Omit<Post, 'content' | 'author' | 'tags'>[]; //новое
//     };
//   };

//   const data = await client.request<Response>(query, { categorySlug: slug });
